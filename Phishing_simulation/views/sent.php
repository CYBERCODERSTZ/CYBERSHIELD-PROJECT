          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              <div class="mailbox-controls">
                ...
                <div class="btn-group">
                   <a  href=sent.php?del=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete?');" type="button" class="btn btn-default btn-sm">
                   <i class="far fa-trash-alt"></i></a>  
                </div>
                <!-- /.btn-group -->
                <button type="button" class="btn btn-default btn-sm">
                  <a href="ps_admin.php?page=sent"><i class="fas fa-sync-alt"></i></a>
                </button>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                 ...
                 <?php
                    ...
                    $i = 1;
                    $selected = mysqli_query($conn,"SELECT * FROM `email`,`user` WHERE user.roll_number=email.SenderID AND user.Email='$session_id'");
