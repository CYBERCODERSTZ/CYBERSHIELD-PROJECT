...
$roll_number=$cat."/TR/".$year."/".$zero.$num; 
 ...
 if  ($PasswordHash != $retype_password){
  ...
  $query=mysqli_query($conn,"INSERT INTO `user`(`roll_number`,`FullName`, `Email`,`terms`,`Role`, `PasswordHash`) VALUES('$roll_number','$FullName','$Email','$terms','$Role','$PasswordHash')");
  ...
  if($query){ 
        ...
        ?>  
        <script type="text/javascript">
         alert("Sorry Your not Register, Try again !");
        </script>
        <?php
    }
}
   ...
   <div class="card card-widget widget-user card-info card-outline">
    ...
    <div class="card-body register-card-body">
      ...
      <form action="" method="post" id="quickForm">
        ...
        <input type="hidden" name="Role" value="Training">
        <div class="input-group mb-3">
      ...
      <a href="views/Tra_login.php" class="text-center">I already have a membership</a>
       <hr>
