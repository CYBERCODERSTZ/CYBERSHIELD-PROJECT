  ...
  <div class="intro intro-single route bg-image" style="background-image: url(../assets/img/Incident_report/1_incident.png)">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <h2 class="intro-title mb-4">Incident Reporting</h2>
          ...
          <div class="col-md-8">
            <div class="post-box">
              ...
              <div class="article-content text-justify">
                <p>
                The proposed cyber incident reporting framework for the CyberShield affiliates aims to strike a balance between collecting essential information and minimizing the burden on organizations. It includes general information fields applicable to all incidents, such as victim information, incident type, incident details, and threat actor information. These fields enable our team to identify reporting entities, categorize incidents, and support trend analysis and response efforts. Additionally, specific incident information fields are tailored to different types of incidents, such as business email compromise, ransomware, data theft, financial theft, phishing, and unwanted surveillance. These fields provide crucial details relevant to each incident type, facilitating investigation, trend analysis, and response coordination
                </p>
