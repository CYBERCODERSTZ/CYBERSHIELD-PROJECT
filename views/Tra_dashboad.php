      ...
      <div class="container-fluid" >
        <div class="row mb-2">
          <?php  
               ...
               ?>
          <div class="col-sm-6" >
            <h5><strong >Welcome To Training Management System </strong></h5>
          </div>
          <div class="col-sm-6">
                        ...
                        <div class="timeline-item">
                          ...
                          <div class="timeline-body">
                           <form action="" method="post">
                              ...
                              <input type="hidden" name="RecipientID" value="info@cyberShield.ac.tz"> 
                              ...
                              <div class="row" style="text-align: right">
                                  <div class="col-md-12"> 
                                      <button type="submit" name="comment_n" class="btn btn-secondary btn-sm">  <i class="fa fa far fa-envelope"></i> Send</button>
                                  </div>
                              </div>
                          </form>
                          </div> 
