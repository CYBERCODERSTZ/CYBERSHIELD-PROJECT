...
header('location:admin.php?page=phishing"');
}
  ...
  <div class="content-wrapper"> 
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <a><strong>Training Management information</strong></a>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header p-2"> 
                   <i class="fas fa-th-list"></i> Trainer List  
              </div>
              <!-- /.card-header --> 
              <div class="card-body">    
                <div class="row">
                    ...
                    <table id="example1" class="table table-striped display table-bordered" >
                      <thead>
                        ...
                        <tbody>
                          <?php 
                            $i = 1;
                            $selected = mysqli_query($conn,"SELECT * From user WHERE roll_number LIKE '%CYBER/PS/%'");
                        ...
                        <tr>
                          ...
                          <td>
                            <?php
                              if($row["Role"] == 'user')
                                 {?>
                                <a href="admin.php?page=phishing&Id_4=<?php echo $row['UserID']; ?>" onclick="return confirm('Are you sure you want to Authorizy a Training?');" >  <button class="btn btn-info"> User</button>
                                <?php } else if($row["Role"]=='Training'){?>
                                  <a href="admin.php?page=phishing&Id_5=<?php echo $row['UserID']; ?>" onclick="return confirm('Are you sure you want to Authorizy a User?');"><button class="btn btn-success"> Trainer</button> 
                                 <?php } ?>
                          ...
                          <td>
                            <?php
                              if($row["user_status"] == 'Enable')
                                 {?>
                                <a href="admin.php?page=phishing&Id_3=<?php echo $row['UserID']; ?>" onclick="return confirm('Are you sure you want to block a Trainer?');" >  <button class="btn btn-secondary"> Enable</button>
                                <?php } else if($row["user_status"]=='Disable'){?>
                                  <a href="admin.php?page=phishing&Id_2=<?php echo $row['UserID']; ?>" onclick="return confirm('Are you sure you want to active a Trainer?');"><button class="btn btn-danger"> Disable</button> 
                                 <?php } ?>
