 ...
 <div class="content-wrapper"> 
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <a><strong>Technical Desk Page</strong></a>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">IRP</a></li>
              <li class="breadcrumb-item active">Technical Desk</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills ">
                  <li class="nav-item"><a class="nav-link active" href="#teacher" data-toggle="tab"><i class="fas fa-file"></i> Technical Desk Files</a></li> 
                      ...
                      <thead>
                        ...
                        <tbody>
                          <?php
                            include ('includes/connection.php'); 
                            $i = 1;
                            $selected = mysqli_query($conn,"SELECT * FROM `resources`,`user` where resources.UserID=user.UserID AND resources.Type='Technical Desk'");
                    ...
                    <div class="card-body">
                      <div class="row">  
                        <?php 
                           ...
                           ?>
                       <input type="hidden" name="Type" value="Technical Desk">
                        <div class="col-md-6">
