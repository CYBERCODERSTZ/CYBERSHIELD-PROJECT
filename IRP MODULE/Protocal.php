 ...
 <div class="content-wrapper"> 
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <a><strong>Incident Protocal Page</strong></a>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">IRP</a></li>
              <li class="breadcrumb-item active">Incident Protocal</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills ">
                  <li class="nav-item"><a class="nav-link active" href="#teacher" data-toggle="tab"><i class="fas fa-file"></i> Incident Protocal Files</a></li> 
                    ...
                    <div class="card-body">
                      <div class="row">  
                        <?php 
                           ...
                           ?>
                          <input type="hidden" name="Type" value="Incident Protocol">
